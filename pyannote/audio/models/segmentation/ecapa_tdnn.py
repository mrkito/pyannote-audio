...
if __name__ == '__main__':
    # x = torch.zeros(23, 1000)
    # model = ECAPA_TDNN_SMALL(feat_dim=768, emb_dim=256, feat_type='fbank', feature_selection="hidden_states",
    #                          update_extract=False)
    #
    # out = model(x)
    # print(out.shape)
    #
    x = torch.zeros(23, 768, 201)
    model = ECAPA_TDNN_SMALL(feat_dim=768, emb_dim=256,  feature_selection="hidden_states",update_extract=False)
